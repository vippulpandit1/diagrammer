...
export const UMLPackageGlyph: React.FC<{ size: number }> = ({ size }) => (
  <g>
    ...
    <text x={size/2} y={size*0.2} fontSize={size*0.16} fill="#222" textAnchor="middle" dominantBaseline="middle">&lt;&lt;Package&gt;&gt;</text>
  </g>
);