...
export const UMLEnumGlyph: React.FC<{ size: number }> = ({ size }) => (
  <g>
    ...
    <text x={size/2} y={size*0.2} fontSize={size*0.16} fill="#222" textAnchor="middle" dominantBaseline="middle">&lt;&lt;enum&gt;&gt;</text>
  </g>
);