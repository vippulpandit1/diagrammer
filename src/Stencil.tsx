...
const STENCIL_GLYPHS = {
  ...
  cloud: [
    { type: "cloud-vm",             label: "VM",             inputs: 1, outputs: 1 },
    { type: "cloud-container",      label: "Container",      inputs: 1, outputs: 1 },
    { type: "cloud-function",       label: "Function",       inputs: 1, outputs: 1 },
    { type: "cloud-kubernetes",     label: "Kubernetes",     inputs: 1, outputs: 1 },
    { type: "cloud-object-storage", label: "Object Storage", inputs: 1, outputs: 1 },
    { type: "cloud-block-storage",  label: "Block Storage",  inputs: 1, outputs: 1 },
    { type: "cloud-database",       label: "Database",       inputs: 1, outputs: 1 },
    { type: "cloud-cache",          label: "Cache",          inputs: 1, outputs: 1 },
    { type: "cloud-vpc",            label: "VPC",            inputs: 1, outputs: 1 },
    { type: "cloud-load-balancer",  label: "Load Balancer",  inputs: 1, outputs: 1 },
    { type: "cloud-cdn",            label: "CDN",            inputs: 1, outputs: 1 },
    { type: "cloud-api-gateway",    label: "API Gateway",    inputs: 1, outputs: 1 },
    { type: "cloud-iam",            label: "IAM",            inputs: 1, outputs: 1 },
    { type: "cloud-firewall",       label: "Firewall",       inputs: 1, outputs: 1 },
    { type: "cloud-waf",            label: "WAF",            inputs: 1, outputs: 1 },
    { type: "cloud-kms",            label: "KMS",            inputs: 1, outputs: 1 },
    { type: "cloud-queue",          label: "Queue",          inputs: 1, outputs: 1 },
    { type: "cloud-event-bus",      label: "Event Bus",      inputs: 1, outputs: 1 },
    { type: "cloud-monitoring",     label: "Monitoring",     inputs: 1, outputs: 1 },
    { type: "cloud-cicd",           label: "CI/CD",          inputs: 1, outputs: 1 },
  ],
  mcp: [
